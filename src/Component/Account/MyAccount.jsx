        ...
        <Container>
          <Row>
            ...
            <Col md={5} sm={12} xs={12}>
                ...
                <button className="MyAccount__editbutton">edit</button>
              <ListGroup>
                <ListGroup.Item> <b>Name :</b> {name} </ListGroup.Item>
                <ListGroup.Item><b>Country :</b> {country} </ListGroup.Item>
                <ListGroup.Item><b>Phone :</b> {phone} </ListGroup.Item>
                <ListGroup.Item><b>Email :</b> {email} </ListGroup.Item>
                <ListGroup.Item><b>Address :</b> {address} </ListGroup.Item> <br /> <br />
              </ListGroup>

              <h1 className="MyAccount__head">Delete Account</h1>
              <ListGroup>
              <ListGroup.Item id="DeleteAccount"> <button className="MyAccount__deletebutton" onClick={HandleDeleteOption}>Delete My Account</button> </ListGroup.Item> <br /> <br />
