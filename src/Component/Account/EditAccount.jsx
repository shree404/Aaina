...
function EditAccount(){
    ...
    return(
        ...
        >
          <Form.Control type="text" id="edituserdetails" name="username" required placeholder="Full Name" />
        </FloatingLabel>
        <FloatingLabel
        ...
        >
          ...
          />
           ...
           <button className="EditAccount-changePassword" onClick={HandlePassword}>Change Password</button>
