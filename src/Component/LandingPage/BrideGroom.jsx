        ...
        <Container>
          ...
          <div>
            <Row>
              ...
              <Col md={4} sm={12} xs={12}>
              <p className="container-BrideandGroomSection-buynow-middleSection__description"><span className="container-BrideandGroomSection-buynow-middleSection__description__word">Handcrafted</span>  Masterpieces <br /> for Your Special Day </p>
                <p className="container-BrideandGroomSection-buynow-middleSection__description2">Explore Our Bridal & Groom <br /> Collection</p>
                <button className="container-BrideandGroomSection-buynow-middleSection__button">BUY NOW</button>
              </Col>
              <Col md={4} sm={12} xs={12}>
